...
const EditVerticalTable = ({ fromId, item, setArraydata, ifExist, divTwoRef }) => {
        ...
        try {
            ...
            const modifiedBodyArray = eachBodyArray.map((eachRow, rowIndex) => {
                ...
                for (const key in eachRow) {
                    ...
                    // console.log(eachRow)
                    // console.log(typeof eachObjectValue === 'object');
                    let response = '';
                    ...
                    if (typeof eachObjectValue === 'object') {
                        ...
                        // console.log(eachObjectKey, eachObjectValue, 'else object');
                    } else {
                        // console.log(eachObjectValue);
                        // console.log(eachObjectKey, eachObjectValue);

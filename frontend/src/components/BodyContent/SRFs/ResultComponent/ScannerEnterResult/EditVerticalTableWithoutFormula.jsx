...
const EditVerticalTableWithoutFormula = ({ fromId, item, divTwoRef, calculateTrigger, setCalTrigger, setCalculated, key }) => {
    ...
    const renderRows = () => {
        ...
        inputCells.forEach((inputKey) => {
            ...
            splitedTable.push(<table className='tableStyle' style={{ marginBottom: '20px' }}>
                <tbody>
                    {eachRow}
                </tbody>
            </table>)
